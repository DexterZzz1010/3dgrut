...
from threedgrut.datasets.utils import read_next_bytes, read_colmap_points3D_text,read_colmap_points3D_text_with_sampling
...
class MixtureOfGaussians(torch.nn.Module, ExportableModel):
    ...
    def init_from_colmap(self, root_path: str, observer_pts):
        ...
        if self.conf.dataset.type == "scannetpp":
            ...
            points_file = os.path.join(root_path, "colmap", "points3D_1M.txt")
